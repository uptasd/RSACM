...
//                                                   ":模拟第" + r_index + "个需求part" + (i + 1) + ":" + requirementBean.getRequiredFunction().getLocalName() +
//                                                   ":请求1个," +
//                                                   "占用" + requirementBean.getRequiredTime() + "周期," +
//                                                   "请求" + requirementBean.getRequireQos() + "资源," +
//                                                   "紧急程度为:" + requirementBean.getUrgencyLevel());
