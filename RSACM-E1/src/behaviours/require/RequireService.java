...
//    private MessageTemplate checkCapacityMT;
    ...
    public RequireService(int requirementID, AtomicInteger stepChain, int processID, int processCnt, int period, RequirementInfo requirementInfo, String nextRequirement,
            ...
            Map<String, Integer> affectedAgent, Map<String, Long> retrieveTime, Map<String, Long> propagationTime,
            int noiseRate) {
...
//                    int id = requiredID;
                ...
                case 6:
                    if (processID == endId) {
                        ...
                        String fileName1 = "状态更新次数-" + noiseRate + ".txt";
                        String fileName2 = "检索时间-" + noiseRate + ".txt";
                        String fileName3 = "传播时间-" + noiseRate + ".txt";
