...
//                        System.out.println(myAgent.getLocalName() + "-min:" + min);
                            serviceNum.set(min);
//                            if(myAgent.getLocalName().equals("中山大学第三附属医院-网络服务")){
//                                System.out.println("中山大学第三附属医院-网络服务:old-"+last_serviceNum+";new:"+serviceNum.get());
//                            }
...
//                                            }
                    ...
                    if (checkMode.equals("replaceMode")) {
                        ...
                        if (checkMode.equals("global")) {
                            ...
                            if (new_num != old_num) {
//                                if (myName.equals("血液内科-医生值班")) {
//                                    System.out.println(myName + ":add before-" + updatedAgent.size());
//                                }
                                updatedAgent.add(myAgent.getLocalName());
//                                if (myName.equals("血液内科-医生值班")) {
//                                    System.out.println(myName + ":add after-" + updatedAgent.size());
//                                }
//                                if (myName.equals("血液内科-医生值班")) {
//                                    System.out.println(myName + ":last num-" + old_num+",new num-"+new_num);
//                                }
